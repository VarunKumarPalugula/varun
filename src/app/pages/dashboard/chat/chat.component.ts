...
export class ChatComponent implements OnInit {
  ...
  public contacts: Observable<any[]> = this.cometChatService.getUsers();
  public incomingCall$: Observable<any> = this.cometChatService.getIncomingCalls();
  public ongoingCall$: Observable<any> = this.cometChatService.getOngoingCalls();
  ...
  public voiceCall(): void {
    this.cometChatService.startVoiceCall(this.currentData.uid).subscribe();
  }
  ...
  //     header: '',
  //     subHeader: 'Accept or Reject Call',
  //     message: '',
